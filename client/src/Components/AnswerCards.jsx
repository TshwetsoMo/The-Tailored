...
const AnswerCards = (props) => {
    ...
    useEffect(() => {
        ...
        Axios.get('https://opendevtshwetso-6f3e4dc7555d.herokuapp.com/api/getUser/' + props.user)
            .then(res => {
                setUsername(res.data.username);
                console.log(res.data);
                const serverURL = 'https://opendevtshwetso-6f3e4dc7555d.herokuapp.com/userimages';
