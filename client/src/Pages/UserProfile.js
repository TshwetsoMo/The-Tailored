...
function Profile() {
    ...
    useEffect(() => {
        ...
        axios.get('https://opendevtshwetso-6f3e4dc7555d.herokuapp.com/api/userquestions/' + userID)
            .then((result) => {
        ...
        const fetchData = async () => {
            console.log('fetch');
            try {
                const userResponse = await axios.get('https://opendevtshwetso-6f3e4dc7555d.herokuapp.com/api/getUser/' + userID);
    ...
    const save = (e) => {
        ...
        axios.put('https://opendevtshwetso-6f3e4dc7555d.herokuapp.com/api/updateuser/' + userID, updateUser)
            .then(() => {
