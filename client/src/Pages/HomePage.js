...
function HomePage() {
    ...
    const [axiosCall, setAxiosCall] = useState('https://opendevtshwetso-6f3e4dc7555d.herokuapp.com/api/question_get_all');
    ...
    useEffect(() => {
        if (axiosCall.startsWith('https://opendevtshwetso-6f3e4dc7555d.herokuapp.com/api/question_get_all')) {
            Axios.get(axiosCall)
                .then(res => {
    ...
    const handleSearch = () => {
        if (searcher === '') {
            setAxiosCall('https://opendevtshwetso-6f3e4dc7555d.herokuapp.com/api/question_get_all');
        } else {
            setAxiosCall('https://opendevtshwetso-6f3e4dc7555d.herokuapp.com/api/searchquestion/' + searcher);
        }
    }
    ...
    const handleLoadMore = () => {
        ...
        if (newLoaded >= totalEntries) {
            setloadMoreS(false);
            setAxiosCall(`https://opendevtshwetso-6f3e4dc7555d.herokuapp.com/api/question_get_all/?page=${nextpage}`);
        } else {
            setAxiosCall(`https://opendevtshwetso-6f3e4dc7555d.herokuapp.com/api/question_get_all/?page=${nextpage}`);
        }
    }
